 ...
 */
class UpdatePlaylistInformationAdditionalFieldProvider extends AbstractAdditionalFieldProvider
{
    /**
     * @var string
     */
    ...
    public function validateAdditionalFields(array &$submittedData, SchedulerModuleController $schedulerModule): bool
    {
        ...
        if ($submittedData['mediapool_playlist_mode'] === 0) {
            ...
            $submittedData['mediapool_playlist_page_selection'] = implode(
                ',',
                GeneralUtility::intExplode(',', $submittedData['mediapool_playlist_page_selection'])
            );
        }
