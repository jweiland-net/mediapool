...
On non composer based TYPO3 installations you can install `mediapool` still
...
4.  Install `mediapool`
    ...
    Use the search field to find `mediapool`. Choose the `mediapool` line
    from the search result and click on the cloud icon to install `mediapool`.

Next step
=========

:ref:`Configure mediapool <configuration>`.
